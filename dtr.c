...
/*void calc(){
            ...
            hrs_work_hrs = hrs_work / 60; 
            hrs_work_min = hrs_work % 60;
            total_work_hrs = total_work_hrs + hrs_work;
            total_late = total_late + late;
            total_undertime = total_undertime + undertime;
            ttl_work_hrs = total_work_hrs / 60;
            ttl_work_min = total_work_hrs % 60;
            ...
            weekly_salary = total_work_hrs / 60 * 100; 
} */
